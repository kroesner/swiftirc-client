...
Private Sub UserControl_Resize()
    ...
    If Not m_nicklist Is Nothing Then
        Set window = m_nicklist
        window.realWindow.Move UserControl.ScaleWidth - m_nicklistWidth, 0, m_nicklistWidth, UserControl.ScaleHeight - m_textInputHeight
    End If
    
    If Not m_textView Is Nothing Then
        Set window = m_textView
        window.realWindow.Move 0, 0, UserControl.ScaleWidth - m_nicklistWidth, UserControl.ScaleHeight - m_textInputHeight
    End If
